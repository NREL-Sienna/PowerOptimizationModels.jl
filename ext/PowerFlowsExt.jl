...
using PowerFlows
import PowerOptimizationModels: POM, PFS, IS, PNM, PSY, PM
...
PowerOptimizationModels.PowerFlowEvaluationData = PowerFlowEvaluationData
PowerOptimizationModels.check_network_reduction = check_network_reduction
PowerOptimizationModels.get_power_flow_data = get_power_flow_data
PowerOptimizationModels.get_input_key_map = get_input_key_map
