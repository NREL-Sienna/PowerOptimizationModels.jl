...
get_executions(model::OperationModel) = get_executions(get_internal(model))
...
get_status(model::OperationModel) = get_status(get_internal(model))
...
get_output_dir(model::OperationModel) = get_output_dir(get_internal(model))
